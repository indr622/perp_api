 ...
 * Yubi Technology
 * Name of file: CustomerStoreRequest.php
 * Date: 2022-12-29
 */
...
class CustomerStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'phone'                 => 'required|string|unique:customers,phone|numeric',
    ...
    public function messages()
    {
        return [
            ...
            'name.unique'           => 'Customer name has already been taken.',
            ...
            'email.unique'          => 'Customer email has already been taken.',

            'phone.required'        => 'Customer phone is required.',
            'phone.string'          => 'Customer phone must be a string.',
            'phone.unique'          => 'Customer phone has already been taken.',
