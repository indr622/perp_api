 ...
 * Yubi Technology
 * Name of file: QuotationStoreRequest.php
 * Date: 2022-02-02
 */
...
class QuotationStoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'quo_order_date.required'       => 'Order Date is required.',
            'quo_order_date.date'           => 'Order Date must be a date.',
            'quo_request_date.required'     => 'Request Date is required.',
            'quo_request_date.date'         => 'Request Date must be a date.',
            'quo_shipping_address.required' => 'Shipping Address is required.',
        ];
    }
    ...
    protected function failedValidation(Validator $validator)
    {
        throw new HttpResponseException(
            response()->json([
                'status'        => false,
                'pid'           => 'STORE',
                'message'       => 'Quotation data failed to STORE.',
