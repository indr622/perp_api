...
<head>
    <title>Sales Order - {{ $data['so_number'] }}</title>
    ...
    <div class="content-wrapper">
        ...
        <div style="margin-top: 25px">
            <table class="order-detail-container align-text-center">
                <tr>
                    <th class="table-head-border">Customer PO.</th>
                    <th>Sales Order No.</th>
                    <th>Order Date</th>
                </tr>
                <tr>
                    <td>{{ $data['customer_po'] ?? 'N/A' }}</td>
        ...
        <div class="address-container">
            <div class="company-address-container company-address">
                <strong class="address-label">CUSTOMER</strong>
            ...
            <div class="billing-address-container company-address">
                ...
                {{ $data['so_shipping_name'] }}
                <br>
                {{ $data['so_shipping_email'] }}
                <br />
                {{ $data['so_shipping_phone'] }}
                <br />
            ...
            <table style="width: fit-content" cellspacing="0px" border="0" class="total-display-table page-break">
                <tr>
                    ...
                    <td class="border-0 item-cell total-table-attribute-value">
                        {{ $data['currency']->name }} {{ number_format($data['so_subtotal'], 0, ',', ',') }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="border-0 item-cell total-table-attribute-value">
                        {{ $data['currency']->name }} {{ number_format($data['so_additional_cost'], 0, ',', ',') }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="border-0 item-cell total-table-attribute-value">
                        {{ $data['currency']->name }} {{ $data['so_vat'] }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="py-8 border-0 total-border-right item-cell total-table-attribute-value"
                        ...
                        {{ $data['currency']->name }} {{ number_format($data['so_total'], 0, ',', ',') }}
                    </td>
                </tr>
            </table>
        </div>
        <div class="notes_container">
            <div class="notes">
                <h4 style="color: #040405">
                    PAYMENT TERMS :{{ $data['so_term_payment'] }}
                </h4>
                <h4 style="color: #040405">
                    SHIPPING TERMS :{{ $data['term_shipping']->name }}
                </h4>
                <h4 style="color: #040405">TERM AND CONDITION : {{ $data['so_term_and_condition'] }}</h4>
            </div>
            <div class="notes">
